        ...
        <div className="min-h-screen flex">
            ...
            <div className="flex-1 flex items-center justify-center p-8">
                <div className="w-full max-w-md space-y-8 animate-fade-in">
                    ...
                    <a href="http://localhost:8080/oauth2/authorization/google" className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-surface-200 dark:border-surface-800 rounded-xl hover:bg-surface-50 dark:hover:bg-surface-900 transition-colors font-medium text-surface-700 dark:text-surface-300 shadow-sm">
